...
internal fun identifyPhoto(context: Context, jpeg: ByteArray): Identification {
    ...
    val apiKey = "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"
    require(apiKey.isNotBlank()) { "Entre ta clé API dans Caméra → Clé API ⚙." }
